package uk.bl.wap.hadoop.mapreduce.cdx;
...
import org.archive.wayback.hadoop.AlphaPartitioner;

import uk.bl.wap.hadoop.mapreduce.io.TextOutputFormat;
import uk.bl.wap.hadoop.mapreduce.lib.ArchiveToCDXFileInputFormat;
